...
class SearchApi:
    ...
    @validate_call
    def semantic_query_suggestions(
        self,
        account_id: Annotated[
            StrictStr, Field(description="The account to get information on")
        ],
        ...
        semantic_query_suggestions_query: Annotated[
            SemanticQuerySuggestionsQuery,
            Field(
                description="Configuration required to return query suggestions"
            ),
        ],
        _request_timeout: Union[
            None,
        ...
        Suggestions based on query text

        :param account_id: The account to get information on (required)
        :type account_id: str
        :param collection_id: The collection id to get details for {collection_id} (required)
        :type collection_id: str
        :param semantic_query_suggestions_query: Configuration required to return query suggestions (required)
        ...
        _param = self._semantic_query_suggestions_serialize(
            account_id=account_id,
            collection_id=collection_id,
    ...
    @validate_call
    def semantic_query_suggestions_with_http_info(
        self,
        account_id: Annotated[
            StrictStr, Field(description="The account to get information on")
        ],
    ...
    @validate_call
    def semantic_query_suggestions_without_preload_content(
        self,
        account_id: Annotated[
            StrictStr, Field(description="The account to get information on")
        ],
    ...
    def _semantic_query_suggestions_serialize(
        self,
        account_id,
        collection_id,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/search/{account_id}/{collection_id}/semantic_query_suggestions',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
