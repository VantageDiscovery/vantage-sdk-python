...
class SearchApi:
    ...
    def semantic_query_suggestions_search(
        ...
        semantic_query_suggestions_query: Annotated[
            Optional[SemanticQuerySuggestionsQuery],
            Field(
                description="The JSON that describes how Vantage should search a collection"
            ),
        ] = None,
        ...
        Semantic Query Suggestions Search

        :param account_id: The account to get information on (required)
        :type account_id: str
        :param collection_id: The collection id to get details for {collection_id} (required)
        :type collection_id: str
        :param semantic_query_suggestions_query: The JSON that describes how Vantage should search a collection
        :type semantic_query_suggestions_query: SemanticQuerySuggestionsQuery
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._semantic_query_suggestions_search_serialize(
            account_id=account_id,
            collection_id=collection_id,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "SemanticQuerySuggestionsResult",
            '206': "SemanticQuerySuggestionsResult",
            '405': None,
        }
        response_data = self.api_client.call_api(
            *_param, _request_timeout=_request_timeout
    ...
    @validate_call
    def semantic_query_suggestions_search_with_http_info(
        self,
        account_id: Annotated[
            StrictStr, Field(description="The account to get information on")
        ],
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[SemanticQuerySuggestionsResult]:
        """Semantic Query Suggestions
    ...
    @validate_call
    def semantic_query_suggestions_search_without_preload_content(
        self,
        account_id: Annotated[
            StrictStr, Field(description="The account to get information on")
        ],
    ...
    def _semantic_query_suggestions_search_serialize(
        self,
        account_id,
        collection_id,
        semantic_query_suggestions_query,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if semantic_query_suggestions_query is not None:
            _body_params = semantic_query_suggestions_query
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/v1/search/{account_id}/{collection_id}/semantic_query_suggestions',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
