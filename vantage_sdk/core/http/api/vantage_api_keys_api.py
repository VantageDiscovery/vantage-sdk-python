...
class VantageAPIKeysApi:
    ...
    def _create_vantage_api_key_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/account/{account_id}/vantage_api_key',
    ...
    def deactivate_vantage_api_key(
        ...
        _param = self._deactivate_vantage_api_key_serialize(
            account_id=account_id,
    ...
    @validate_call
    def deactivate_vantage_api_key_with_http_info(
        self,
        account_id: Annotated[
            StrictStr, Field(description="The account these keys are within")
        ],
    ...
    @validate_call
    def deactivate_vantage_api_key_without_preload_content(
        self,
        account_id: Annotated[
            StrictStr, Field(description="The account these keys are within")
        ],
    ...
    def _deactivate_vantage_api_key_serialize(
        self,
        account_id,
        vantage_api_key_id,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/account/{account_id}/vantage_api_key/{vantage_api_key_id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
