...
class AccountManagementApi:
    ...
    def update_account(
        self,
        account_id: Annotated[StrictStr, Field(description="The account to update")],
        account_modifiable: Annotated[AccountModifiable, Field(description="Changes to account.")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
