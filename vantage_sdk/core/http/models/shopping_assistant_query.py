...
class ShoppingAssistantQuery(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["collection", "request_id", "filter", "field_value_weighting", "pagination", "sort", "facets", "text", "max_groups", "shopping_assistant_id"]
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of ShoppingAssistantQuery from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of ShoppingAssistantQuery from a dict"""
        if obj is None:
            return None
