...
class SemanticQuerySuggestionsModifiablePatch(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["external_account_id", "suggestions_per_document"]
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of SemanticQuerySuggestionsModifiablePatch from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of SemanticQuerySuggestionsModifiablePatch from a dict"""
        if obj is None:
            return None
