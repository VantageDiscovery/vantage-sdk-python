...
class Collection(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["collection_created_time", "collection_status", "collection_state", "collection_id", "user_provided_embeddings", "llm", "llm_provider", "llm_secret", "external_url", "embeddings_dimension", "external_key_id", "secondary_external_accounts", "collection_name"]
