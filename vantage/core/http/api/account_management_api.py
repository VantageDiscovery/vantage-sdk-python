...
class AccountManagementApi:
    ...
    def get_user(
        ...
        user_id: Annotated[
            StrictStr,
            Field(..., description="The user to get information about"),
        ],
        **kwargs,
    ) -> User:  # noqa: E501
        """Get user information  # noqa: E501

        Get information about the user {user_id}  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        ...
        :param user_id: The user to get information about (required)
        :type user_id: str
        :param async_req: Whether to execute the request asynchronously.
        :type async_req: bool, optional
        :param _request_timeout: timeout setting for this request.
    ...
    def register_user(
        self,
        user_registration_fields: Annotated[
            UserRegistrationFields,
            Field(..., description="Registration Information"),
        ],
        **kwargs,
    ) -> User:  # noqa: E501
        """Register a new User  # noqa: E501

        Register a new user (one time only)  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.register_user(user_registration_fields, async_req=True)
        >>> result = thread.get()

        :param user_registration_fields: Registration Information (required)
        :type user_registration_fields: UserRegistrationFields
        :param async_req: Whether to execute the request asynchronously.
        :type async_req: bool, optional
        :param _request_timeout: timeout setting for this request.
               If one number provided, it will be total request
        ...
        if '_preload_content' in kwargs:
            ...
            raise ValueError(message)
        return self.register_user_with_http_info(
            user_registration_fields, **kwargs
        )  # noqa: E501
    ...
    def register_user_with_http_info(
        ...
        **kwargs,
        ...
        >>> thread = api.register_user_with_http_info(user_registration_fields, async_req=True)
        >>> result = thread.get()
        ...
        _all_params = ['user_registration_fields']
        _all_params.extend(
            [
                'async_req',
                '_return_http_data_only',
        ...
        # process the body parameter
        _body_params = None
        if _params['user_registration_fields'] is not None:
            _body_params = _params['user_registration_fields']
    ...
    def update_user(
        self,
        user_id: Annotated[
            StrictStr, Field(..., description="The user to update")
        ],
        user_modifiable: Annotated[
            UserModifiable, Field(..., description="Changes to user.")
        ],
        **kwargs,
    ) -> User:  # noqa: E501
        """Update User Information  # noqa: E501

        Update information about the user {user_id}  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.update_user(user_id, user_modifiable, async_req=True)
        >>> result = thread.get()

        :param user_id: The user to update (required)
        :type user_id: str
        :param user_modifiable: Changes to user. (required)
        :type user_modifiable: UserModifiable
        :param async_req: Whether to execute the request asynchronously.
        :type async_req: bool, optional
        :param _request_timeout: timeout setting for this request.
               If one number provided, it will be total request
        ...
        return self.update_user_with_http_info(
            user_id, user_modifiable, **kwargs
        )  # noqa: E501
    ...
    def update_user_with_http_info(
        ...
        **kwargs,
        ...
        >>> thread = api.update_user_with_http_info(user_id, user_modifiable, async_req=True)
        >>> result = thread.get()
        ...
        _all_params = ['user_id', 'user_modifiable']
        _all_params.extend(
            [
                'async_req',
                '_return_http_data_only',
        ...
        # process the body parameter
        _body_params = None
        if _params['user_modifiable'] is not None:
            _body_params = _params['user_modifiable']
    ...
    @validate_arguments
    def user_me(self, **kwargs) -> User:  # noqa: E501
        """Logged in User  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.user_me(async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the user_me_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return self.user_me_with_http_info(**kwargs)  # noqa: E501

    @validate_arguments
    def user_me_with_http_info(self, **kwargs) -> ApiResponse:  # noqa: E501
        """Logged in User  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.user_me_with_http_info(async_req=True)
        >>> result = thread.get()
