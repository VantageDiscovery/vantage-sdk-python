...
class ExternalAPIKeysResult(BaseModel):
    """
    ExternalAPIKeysResult
    """

    collections: Optional[
        conlist(ExternalAPIKeysResultCollectionsInner)
    ] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ExternalAPIKeysResult:
        """Create an instance of ExternalAPIKeysResult from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ExternalAPIKeysResult:
        """Create an instance of ExternalAPIKeysResult from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ExternalAPIKeysResult.parse_obj(obj)

        _obj = ExternalAPIKeysResult.parse_obj(
            {
                "collections": [
                    ExternalAPIKeysResultCollectionsInner.from_dict(_item)
