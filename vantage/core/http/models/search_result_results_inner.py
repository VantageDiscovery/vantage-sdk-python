...
class SearchResultResultsInner(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SearchResultResultsInner:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SearchResultResultsInner:
        """Create an instance of SearchResultResultsInner from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SearchResultResultsInner.parse_obj(obj)

        _obj = SearchResultResultsInner.parse_obj(
