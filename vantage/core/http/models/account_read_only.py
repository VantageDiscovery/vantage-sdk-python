...
class AccountReadOnly(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AccountReadOnly:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AccountReadOnly:
        """Create an instance of AccountReadOnly from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return AccountReadOnly.parse_obj(obj)

        _obj = AccountReadOnly.parse_obj({"account_id": obj.get("account_id")})
        return _obj
