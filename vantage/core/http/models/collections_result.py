...
class CollectionsResult(BaseModel):
    ...
    collections: Optional[conlist(CollectionsResultCollectionsInner)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CollectionsResult:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CollectionsResult:
        """Create an instance of CollectionsResult from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CollectionsResult.parse_obj(obj)

        _obj = CollectionsResult.parse_obj(
            {
                "collections": [
                    CollectionsResultCollectionsInner.from_dict(_item)
