...
class ExternalAPIKeyModifiable(BaseModel):
    ...
    __properties = ["url", "llm_provider", "llm_secret"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ExternalAPIKeyModifiable:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ExternalAPIKeyModifiable:
        """Create an instance of ExternalAPIKeyModifiable from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ExternalAPIKeyModifiable.parse_obj(obj)

        _obj = ExternalAPIKeyModifiable.parse_obj(
            {
                "url": obj.get("url"),
