...
class CollectionUploadURL(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CollectionUploadURL:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CollectionUploadURL:
        """Create an instance of CollectionUploadURL from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CollectionUploadURL.parse_obj(obj)
