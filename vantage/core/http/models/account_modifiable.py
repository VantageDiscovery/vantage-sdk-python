...
class AccountModifiable(BaseModel):
    """
    AccountModifiable
    """

    account_name: Optional[StrictStr] = None
    __properties = ["account_name"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AccountModifiable:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AccountModifiable:
        """Create an instance of AccountModifiable from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return AccountModifiable.parse_obj(obj)

        _obj = AccountModifiable.parse_obj(
